...
function FeatureCard({ heading, description }) {
  return (
    <div className=" bg-opacity- bg-gray-200 text-center rounded-md px-4 py-6 md:py-12 max-w-sm shadow-md">
      ...
      <p className="text-slate-600 text-sm md:text-base font-Rubik">
        {description}
      </p>
    </div>
  );
...
function InfoCard() {
  return (
    <div className="py-20">
      ...
      <div className="flex flex-col gap-3 items-center sm:items-stretch space-y-4 sm:space-y-0 sm:flex-row  sm:justify-around p-4 md:p-8 ">
        <FeatureCard
          heading="Easy to use"
